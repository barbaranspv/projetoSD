...
<head>
    ...
    <title>Register to ucBusca</title>
</head>
<body>
<style>
    :root {
        ...
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            <div class="card card-signin my-5">
                ...
                <div class="card-body" theme="simple">
                    ...
                    <s:form theme="simple" class="form-signin text-center" action="register" method="post" cssClass="well form-search">
                        ...
                        <div class="text-center">
                            <s:submit cssClass="btn btn-lg btn-primary" value="Register" theme="simple"
                                      style="font-size: 80%;
                                      width: 100%;
