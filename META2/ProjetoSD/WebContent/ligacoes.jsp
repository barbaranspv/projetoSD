...
<c:if test="${session.loggedin == true}">
    ...
    <s:form cssClass="form" action="ligacoes" method="post">
        <div class="input-field">
            <s:textfield cssClass="input" type="text" id="name" name="url" required="true" style="background-color: transparent;"/>
            <label for="name" style="background-color: transparent;">Qual página quer ver as ligações?</label>
        </div>
        <s:submit cssClass="example_b" href="add-website-here" target="_blank" rel="nofollow noopener" value="Ver ligações"></s:submit>
    </s:form>
    <div class="results" style="text-align: center; width: 33%; position: absolute; top: 25%; left:35%">
