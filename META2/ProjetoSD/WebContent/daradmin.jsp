...
<c:if test="${session.loggedin == true}">
    ...
    <c:if test="${session.admin == true}">
        <s:form cssClass="form" action="daradmin" method="post">
            <div class="input-field">
                <s:textfield cssClass="input" type="text" id="name" name="usertoadmin" required="true" style="background-color: transparent;"/>
                <label for="name" style="background-color: transparent;">A quem pretende dar privilégios?</label>
            </div>
            <s:submit cssClass="example_b" href="add-website-here" target="_blank" rel="nofollow noopener" value="Dar privilégios"></s:submit>
        </s:form>
    </c:if>
